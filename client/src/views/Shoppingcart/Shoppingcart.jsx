...
import { deleteSalesCart, getSalesCart, updateSalesCart } from '../../reduxToolkit/SalesCarts/salesCartThunk';
...
const ShoppingCart = () => {
  ...
  const handlePayment = async () => {
    try {
      const response = await axios.post('https://drewili-pf-back.onrender.com/payment/create-checkout-session', { cartItems: listItems, id: userId });
      const { data } = response;
