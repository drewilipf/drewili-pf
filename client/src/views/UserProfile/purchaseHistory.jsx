...
const PurchaseHistoryComponent = () => {
  ...
  console.log(purchaseHistory, 'esta es la historia');
  useEffect(() => {
                    ...
                    >
                      ...
                      <div className='p-2 rounded shadow-sm shadow-eerieBlack'>
                        ...
                        <button
                          ...
                          className={`cursor-pointer hover:scale-105 hover:drop-shadow-sm hover:shadow-onyx ${showModal && 'opacity-50 cursor-not-allowed'
                            }`}
                          disabled={showModal}
                        >
                          Opinar
...
export default PurchaseHistoryComponent;
>>>>>>> 3652d8b5910d3b2cfd135f3ad99cf84314f4bbab
